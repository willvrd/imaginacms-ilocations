...
class EloquentPolygonRepository extends EloquentCrudRepository implements PolygonRepository
{
  /**
  ...
  public function filterQuery($query, $filter, $params)
  {
    ...
    if (isset($filter->geozone)) {
      $query->whereHas('translations', function (Builder $q) use ($filter) {
          $q->where('geozonable_type', 'Modules\Ilocations\Entitie\Polygon')->where('geozonable_id', $filter->geozone);
      });
    }
